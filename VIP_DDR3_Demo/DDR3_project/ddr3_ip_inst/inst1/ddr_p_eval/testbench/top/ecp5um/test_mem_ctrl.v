...
`define inst1_READ 4'b0001
`define inst1_WRITE 4'b0010
`define inst1_READA 4'b0011
`define inst1_WRITEA 4'b0100
`define inst1_PDOWN_ENT 4'b0101
`define inst1_LMR 4'b0110
`define inst1_SEL_REF_ENT 4'b1000
`define inst1_SEL_REF_EXIT 4'b1001
`define inst1_PDOWN_EXIT 4'b1011
`define inst1_ZQ_LNG 4'b1100
`define inst1_ZQ_SHRT 4'b1101
...
parameter c = `inst1_REFCLK_PERIOD_BY2;  // PLL_FIN is refclk to PLL.  unit of c is ps.
...
ddr3_sdram_mem_top_inst1 U1_ddr_sdram_mem_top (
...
//`endif 
  ...
  `define inst1_DIMM_CS_WIDTH 1
//--------------- DIMM 0 --------------------------------------

   ddr3_dimm_16_inst1 U0_ddr3_dimm (
       .rst_n              (ddr_resetn),
       .ddr_dq             (ddr_dq),
       .ddr_dqs            (ddr_dqs),
       ...
       .ddr_cas_n          (ddr_cas_n),
       .ddr_we_n           (ddr_we_n),
       .ddr_cs_n           (ddr_cs_n[`inst1_DIMM_CS_WIDTH-1:0]),
       .ddr_clk            (ddr_clk[`inst1_DIMM_CS_WIDTH-1:0]),
       .ddr_clk_n          (~ddr_clk[`inst1_DIMM_CS_WIDTH-1:0]),
       .ddr_cke            (ddr_cke[`inst1_DIMM_CS_WIDTH-1:0]),
       .ddr_odt            (ddr_odt[`inst1_DIMM_CS_WIDTH-1:0])
   );
...
odt_watchdog_inst1 U1_odt_watchdog (
    .mem_clk                   (ddr_clk[0]),
    .rst_n                     (rst_n),
    .ddr_cke                   (ddr_cke[0]),
    .ddr_cs_n                  (ddr_cs_n[0:0]),
