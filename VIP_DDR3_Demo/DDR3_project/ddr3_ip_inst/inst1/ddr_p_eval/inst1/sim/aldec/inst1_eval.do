...
cd {C:/Users/hreddy/Desktop/VIP_DDR3_Demo/DDR3_project/ddr3_ip_inst/inst1/ddr_p_eval/inst1/sim/aldec}
waveformmode asdb
vlog -msg 0 +define+inst1_NO_DEBUG+inst1_SIM+SIM+NO_DEBUG \
...
../../../models/ecp5um/pmi_distributed_dpram.v \
../../../../inst1_beh.v \
...
vsim -O5 +access +r -t 1ps -lib ddr3_design -L ovi_ecp5um ddr3_design.test_mem_ctrl 
